...
// Updated: fix Published checkbox handling
...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || "Sray's Blog", // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '风控技术 · AI实践 · 行业思考', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://sray-s-blog.pages.dev', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '风控,大模型,推荐系统,数据分析,AI', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    '欢迎来到 Risk Frontier, 风控技术与AI实践的前沿探索, 用工程思维解决风控问题',
